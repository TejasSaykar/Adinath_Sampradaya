  ...
  return (
    <Layout>
      <div className="w-full">
        <motion.div className="w-2/4 mx-auto py-2">
          <h2 className="pt-3 text-[12px]">
            <span className="hover:underline hover:text-orange-700 cursor-pointer">
              <Link to={"/"}>Home</Link>
            </span>{" "}
            &nbsp; / &nbsp;{" "}
            <span className="text-orange-700">Wisdom - Adinath Sampradaya</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="w-[86%] mx-auto p-8 text-4xl md:text-7xl py-16 bg-orange-900 text-[#e9ceac]">
            <h2 className="text-center">Adinath Wisdom</h2>
          </div>
        </motion.div>
        <div className="w-full mt-8 pb-4">
          <div className="md:w-[75vw] px-5 md:px-0 grid md:grid-cols-3 gap-4 mx-auto">
